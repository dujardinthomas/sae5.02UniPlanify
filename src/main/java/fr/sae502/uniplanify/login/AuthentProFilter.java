...
public class AuthentProFilter extends HttpFilter {
    ...
    public void doFilter(HttpServletRequest req, HttpServletResponse res, FilterChain chain)
        ...
        if (sessionBean.getUtilisateur() != null) {
            ...
            if(sessionBean.getUtilisateur().isPro()){
                System.out.println("Le client est un pro, poursuite...");
                chain.doFilter(req, res);
            } else {
                System.out.println("Le client n'est pas un pro, on envoie sur login...");
